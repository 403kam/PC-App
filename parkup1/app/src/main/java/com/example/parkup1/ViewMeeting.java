    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot ds) {
                ...
                //TextView title = findViewById(R.id.viewName); i comment
                //title.setText(titlename); i comment
                //TextView addresswhole = findViewById(R.id.viewAddress); i comment
                ...
                //addresswhole.setText(addresswholename); i comment
            }
            @Override
